            ...
            <div class="col-md-6 grid-margin stretch-card">
              ...
              @endif
                  <form class="forms-sample" action="{{ url('admin/add-images/' . $product['id']) }}"
                   method="post" enctype="form-data">@csrf  
                        ...
                        <tbody>
                            @foreach($product['images'] as $image)
                             <tr>
                              ...
                              <td>
                                 <img src="{{ url('front/images/product_images/'
                                 .$image['image']) }}">                   
                              </td>  
                              <td>
                                @if($image['status']==1)
                                  <a class="updateImageStatus" id="image-{{ $image['id'] }}" image_id=
                                  "{{ $image['id'] }}" href="javascript:void(0)">
